...
import type { RollupOutput, RollupBuild, OutputOptions } from 'rollup'
...
export async function writeBundlesFunction(
  ...
  const task: Promise<RollupOutput>[] = []
...
export const PKG_NAME = 'super-ui-plus'

export const PKG_CAMEL_CASE_NAME = 'SuperuiPlus'

export const PKG_PREFIX = '@super-ui-plus'

export const PKG_CAMEL_CASE_LOCAL_NAME = 'SuperuiPlusLocale'
...
export const cssResolver: any = {
  name: 'super-ui-plus-css-resolver',

...
function getSideEffects(
  ...
  const componentsFolder = `super-ui-plus/${module}/components/${noPrefixFilename}/style`
...
function resolveComponent(
  ...
  /**
   * Exclusion of non-compliance with the super-ui-plus naming convention
   */
